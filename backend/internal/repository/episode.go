...
type Episode interface {
	Create(ctx context.Context, conn Conn, e model.Episode) (model.Episode, error)
	GetByID(ctx context.Context, conn Conn, id string) (model.Episode, error)
	...
	GetCurrentRobotEpisode(ctx context.Context, conn Conn, robotID string) (*model.Episode, error)
	List(ctx context.Context, conn Conn, filter EpisodeListFilter, limit, offset int) (model.Episodes, int, error)
	Update(ctx context.Context, conn Conn, e model.Episode) (model.Episode, error)
	...
	SumDurationByTaskID(ctx context.Context, conn Conn, taskID string) (int64, error)
	Export(ctx context.Context, conn Conn, filter EpisodeExportFilter) ([]EpisodeExportRow, error)
}
